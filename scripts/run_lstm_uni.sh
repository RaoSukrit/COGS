...
export LOG_PATH=${OPENNMT_PATH}/logs/1_layer_with_attn_new_vocab_debugging/lstm/lstm_seed_${SEED}          # Log path
export PRED_PATH=${OPENNMT_PATH}/preds/1_layer_with_attn_new_vocab_debugging/lstm/lstm_seed_${SEED}         # Predictions path
