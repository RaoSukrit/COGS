...
def _add_logging_opts(parser, is_train=True):
    ...
    group.add(
        ...
        action="store_true",
        help=(
            "Print data loading and statistics for all process"
...
def tpr_opts(parser):
    ...
    group.add_argument(
        "--tpr_role_mapping", help="role mapping to use from ROLE training", type=str
    )
    group.add(
        "-tpr_config",
        "--tpr_config",
    ...
    group.add_argument("--n_roles", help="number of roles to use", type=int, default=10)
    group.add_argument(
        "--n_fillers", help="number of fillers to use", type=int, default=10
    )
    group.add_argument(
        "--filler_dim", help="embedding dimension for fillers", type=int, default=10
    )
    group.add_argument(
        "--role_dim", help="embedding dimension for roles", type=int, default=6
    )
    group.add_argument(
        "--vocab_size",
        help="vocab size for the training language",
        type=int,
        default=10,
    )
    group.add_argument(
        "--hidden_size", help="size of the encodings", type=int, default=60
    )
    group.add_argument(
        "--save_vectors",
        help="whether to save vectors generated by the fitted TPR model",
        type=str,
        default="False",
    )
    group.add_argument(
        "--save_role_dicts",
        help="whether to save role_to_index and index_to_role or not",
        type=str,
        default="False",
    )
    group.add_argument(
        "--embedding_file",
        help="file containing pretrained embeddings",
        type=str,
        default=None,
    )
    group.add_argument("--weights_matrix", help="", type=int, default=None)
    group.add_argument(
        "--unseen_words",
    ...
    group.add_argument(
        "--neighbor_analysis",
        help="whether to use a neighbor analysis",
        type=str,
        default="True",
    )
    group.add_argument(
        "--digits",
        help="whether this is one of the digit task",
        type=str,
        default="True",
    )
    group.add_argument(
        "--final_linear",
        help="whether to have a final linear layer",
        type=str,
        default="True",
    )
    group.add_argument(
        "--embed_squeeze",
        help="original dimension to be squeezed to filler_dim",
        type=int,
        default=None,
    )
    group.add_argument(
        "--role_learning",
        help="A flag for whether to enable role learning or use " "the provided roles.",
        action="store_true",
    )
    group.add_argument(
        "--bidirectional",
        help="A flag for whether the role learning module is " "bidirectional.",
        action="store_true",
    )
    group.add_argument(
