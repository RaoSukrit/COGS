...
def readLangs(fn_in,
    ...
    input_lang = Lang('Input',
                      ...
                      cogs_vocab_path=cogs_src_vocab_path)
    output_lang = Lang('Output',
                       load_cogs_vocab=load_cogs_vocab,
                       cogs_vocab_path=cogs_tgt_vocab_path)
...
def indexesFromSentence(lang, sentence):
    ...
    input_lang, output_lang, pairs_train = data_loader.prepareData(args.cogs_train_data,
                                                                   verbose=False,
                                                                   load_cogs_vocab=True,
                                                                   cogs_src_vocab_path=args.cogs_src_vocab_path,
                                                                   cogs_tgt_vocab_path=args.cogs_tgt_vocab_path)

    _, _, pairs_test = data_loader.prepareData(args.cogs_test_data,
                                               verbose=False,
                                               load_cogs_vocab=True,
                                               cogs_src_vocab_path=args.cogs_src_vocab_path,
                                               cogs_tgt_vocab_path=args.cogs_tgt_vocab_path)
