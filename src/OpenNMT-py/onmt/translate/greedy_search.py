...
class GreedySearch(DecodeStrategy):
    ...
    def initialize(
        self, memory_bank, src_lengths, src_map=None, device=None, target_prefix=None
    ):
...
class GreedySearchLM(GreedySearch):
    ...
    def initialize(
        self, src, src_lengths, src_map=None, device=None, target_prefix=None
    ):
        """Initialize for decoding."""
        ...
        (fn_map_state, _, self.memory_lengths, src_map) = super(
            GreedySearchLM, self
        ).initialize(None, src_lengths, src_map, device, target_prefix)
